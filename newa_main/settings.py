"""
Django settings for newa_main project.
...
SECRET_KEY = 'django-insecure--+i&0a$*(8_1ou&9^7ednhoa-_0ssq05_8!(u@zwn41n*c(xw7'
...
WSGI_APPLICATION = 'newa_main.wsgi.application'
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',
        'NAME': os.environ.get('DB_NAME', 'newa'),
        'USER': os.environ.get('DB_USER', 'newa_user'),
